...
class EvolverNamespace(BaseNamespace):
    ...
    def custom_functions(self, data, vials, elapsed_time):
        ...
        elif OPERATION_MODE == 'custom_function':
            custom_script.custom_function(self, data, vials, elapsed_time)
        else:
    ...
    def grab_data(self, wait_time = 0.1):
        socketIO.wait(seconds= wait_time)
